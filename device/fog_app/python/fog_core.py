...
../dev_server.py). The detector is analysis/src/streaming_detector.py, the project's reference
...
try:
    ...
    sys.path.insert(0, str(Path(__file__).resolve().parents[3] / "analysis" / "src"))
    from streaming_detector import DetectorParams, SampleClock, StreamingDetector
