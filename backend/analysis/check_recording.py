...
Record a session from the diagnostics page of backend/arduino/fog_app (port 7000), download the CSV and
...
Usage: python analysis/check_recording.py path/to/recording.csv
"""
